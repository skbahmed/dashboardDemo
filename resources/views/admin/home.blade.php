...
<div class="row">
    ...
    <div class="col-md-6 col-sm-6 col-lg-3">
        <div class="mini-stat clearfix bx-shadow">
            ...
            <div class="tiles-progress">
                <div class="m-t-20">
                    <h5 class="text-uppercase">Users <span class="pull-right">100%</span></h5>
                    <div class="progress progress-sm m-0">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="inbox-widget nicescroll mx-box">
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="{{asset('admin')}}/images/users/avatar-6.jpg"
                                    class="img-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="{{asset('admin')}}/images/users/avatar-8.jpg"
                                    class="img-circle" alt=""></div>
                    ...
                    <a href="#">
                        <div class="inbox-item">
                            <div class="inbox-item-img"><img src="{{asset('admin')}}/images/users/avatar-9.jpg"
                                    class="img-circle" alt=""></div>
