        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="{{url('dashboard')}}" class="logo"><i class="md md-terrain"></i> <span> Dashboard </span></a>
                </div>
            </div>
                        ...
                        <ul class="nav navbar-nav navbar-right pull-right">
                            ...
                            <li class="dropdown">
                                <a href="" class="dropdown-toggle profile" data-toggle="dropdown"
                                    aria-expanded="true"><img src="{{asset('admin')}}/images/avatar-1.jpg" alt="user-img"
                                        class="img-circle"> </a>
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                <div class="user-details">
                    <div class="pull-left">
                        <img src="{{asset('admin')}}/images/avatar-1.jpg" alt="" class="thumb-md img-circle">
                    </div>
                    <div class="user-info">
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">{{$currentUserData->name}}
                        ...
                        <p class="text-muted m-0">{{ $currentUserData->role }}</p>
                    </div>
                </div>
                <!--- Divider -->
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="{{route('logout')}}" class="waves-effect">
                                <i class="md md-settings-power"></i><span> Log Out </span>
                            </a>
                        </li>
